...
if(    substr_count($_SERVER['HTTP_HOST'],"192.168") ||
    substr_count($_SERVER['HTTP_HOST'],"no-ip.info") ||
...
if($ambient == "local")
define('BASE_URL','/revolucaobrasileira/rb/cometchat/');
else
...
$plugins = array('handwrite','chattime','clearconversation','chathistory');
...
define('USE_COMET','0');
define('SAVE_LOGS','1');
define('COMET_HISTORY_LIMIT','1000');
define('KEY_A','');
define('KEY_B','');
define('KEY_C','');
