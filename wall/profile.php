...
<div class="UIComposer_Box"> 
  ...
  <input type="hidden" name="keepID" id="keepID" value="<?=isset($_SESSION['id_user']) ? intval($_SESSION['id_user']) : "0";?>" />
...
<div align="center">
  <div id="midbox" align="left">
    <?php include('profile_wall.php')?>
  </div>
</div>
<div id="thing" class="thing"><a href="javascript:mais()">Mais comentários</a> </div>
