...
<div class="middle">
  ...
  <?php for ($i = 0; $i < sizeof($products); $i = $i + 4) { ?>
    <tr>
      ...
      <?php } else { ?>
      <span style="color: #666; font-weight: bold; text-decoration: line-through;"><?php echo $products[$j]['price']; ?></span> <span style="color: #5c936a;font-weight: bold;"><?php echo $products[$j]['special']; ?></span>
      <?php } ?>
