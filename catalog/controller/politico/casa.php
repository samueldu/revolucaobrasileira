<?php   
class ControllerPoliticoCasa extends Controller {
	public function index() { 
		...
		$this->load->model('politico/casa'); 
		
		if(isset($this->request->get['casaid']))
		{   
			$results = $this->model_politico_casa->getCasa($this->request->get['politicoid']);
