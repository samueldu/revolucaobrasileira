...
class ControllerAccountSettings extends Controller {
	public function index() {
		...
		$this->data['id_wall'] = $this->data['id'];
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/settings.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/settings.tpl';
		} else {
			$this->template = 'default/template/account/settings.tpl';
		}
