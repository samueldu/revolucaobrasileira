...
class ControllerAccountForgotten extends Controller {
	...
	public function index() {
        ...
        $this->response->setOutput(Json::encode($this->data['error']));
...
//			$mail->setText(html_entity_decode($message, ENT_QUOTES, 'UTF-8'));
            ...
            $result['url'] = HTTPS_SERVER . 'account/login';

            $result['url'] = "Sua nova senha foi enviada para o seu email. Você será redirecionado para a tela de login.";
        ...
        else
        {
            ...
            $this->data['warning'] = $this->data['error'];

            $this->load->library('json');

            $this->response->setOutput(Json::encode($this->data));
