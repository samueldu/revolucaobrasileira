...
class ModelCheckoutOrder extends Model {
    ...
    public function ipagare($id,$pagamento,$forma,$status,$capturado)
    {
    
        $sql = "INSERT INTO `" . DB_PREFIX . "ipagare_order` SET `order` = '" . $id . "', forma = '".$forma."', meio = '".$pagamento."', status= '".$status."', capturado = '".$capturado."'";
    ...
    public function create($data) {
      ...
      if (!isset($this->session->data['order_id'])) {
         $this->db->query("INSERT INTO `" . DB_PREFIX . "order` SET order_status_id = '0', store_id = '" . (int)$data['store_id'] . "', store_name = '" . $this->db->escape($data['store_name']) . "', store_url = '" . $this->db->escape($data['store_url']) . "', customer_id = '" . (int)$data['customer_id'] . "', customer_group_id = '" . (int)$data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', total = '" . (float)$data['total'] . "', language_id = '" . (int)$data['language_id'] . "', currency = '" . $this->db->escape($data['currency']) . "', currency_id = '" . (int)$data['currency_id'] . "', value = '" . (float)$data['value'] . "', coupon_id = '" . (int)$data['coupon_id'] . "', ip = '" . $this->db->escape($data['ip']) . "', shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) . "', shipping_company = '" . $this->db->escape($data['shipping_company']) . "', shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) . "', shipping_address_2 = '" . $this->db->escape($data['shipping_address_2']) . "',  shipping_address_3 = '" . $this->db->escape($data['shipping_address_3']) . "',  shipping_bairro = '" . $this->db->escape($data['shipping_bairro']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', shipping_zone = '" . $this->db->escape($data['shipping_zone']) . "', shipping_zone_id = '" . (int)$data['shipping_zone_id'] . "', shipping_country = '" . $this->db->escape($data['shipping_country']) . "', shipping_country_id = '" . (int)$data['shipping_country_id'] . "', shipping_address_format = '" . $this->db->escape($data['shipping_address_format']) . "', shipping_method = '" . $this->db->escape($data['shipping_method']) . "', payment_firstname = '" . $this->db->escape($data['payment_firstname']) . "', payment_lastname = '" . $this->db->escape($data['payment_lastname']) . "', payment_company = '" . $this->db->escape($data['payment_company']) . "', payment_address_1 = '" . $this->db->escape($data['payment_address_1']) . "', payment_address_2 = '" . $this->db->escape($data['payment_address_2']) . "',  payment_address_3 = '" . $this->db->escape($data['payment_address_3']) . "',  payment_bairro = '" . $this->db->escape($data['payment_bairro']) . "', payment_city = '" . $this->db->escape($data['payment_city']) . "', payment_postcode = '" . $this->db->escape($data['payment_postcode']) . "', payment_zone = '" . $this->db->escape($data['payment_zone']) . "', payment_zone_id = '" . (int)$data['payment_zone_id'] . "', payment_country = '" . $this->db->escape($data['payment_country']) . "', payment_country_id = '" . (int)$data['payment_country_id'] . "', payment_address_format = '" . $this->db->escape($data['payment_address_format']) . "', payment_method = '" . $this->db->escape($data['payment_method']) . "', comment = '" . $this->db->escape($data['comment']) . "', date_modified = NOW(), date_added = NOW(), cpfCnpj = '" . $this->db->escape($data['cpfCnpj']) . "', rg = '" . $this->db->escape($data['rg']) . "', sexo = '" . $this->db->escape($data['sexo']) . "', dataNasc = '" . $this->db->escape($data['dataNasc']) . "'");

         $order_id = $this->db->getLastId();
      } else {
         $order_id = $this->session->data['order_id'];

         $this->db->query("UPDATE `" . DB_PREFIX . "order` SET order_status_id = '0', store_id = '" . (int)$data['store_id'] . "', store_name = '" . $this->db->escape($data['store_name']) . "', store_url = '" . $this->db->escape($data['store_url']) . "', customer_id = '" . (int)$data['customer_id'] . "', customer_group_id = '" . (int)$data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', total = '" . (float)$data['total'] . "', language_id = '" . (int)$data['language_id'] . "', currency = '" . $this->db->escape($data['currency']) . "', currency_id = '" . (int)$data['currency_id'] . "', value = '" . (float)$data['value'] . "', coupon_id = '" . (int)$data['coupon_id'] . "', ip = '" . $this->db->escape($data['ip']) . "', shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) . "', shipping_company = '" . $this->db->escape($data['shipping_company']) . "', shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) . "', shipping_address_2 = '" . $this->db->escape($data['shipping_address_2']) . "', shipping_address_3 = '" . $this->db->escape($data['shipping_address_3']) . "',  shipping_bairro = '" . $this->db->escape($data['shipping_bairro']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', shipping_zone = '" . $this->db->escape($data['shipping_zone']) . "', shipping_zone_id = '" . (int)$data['shipping_zone_id'] . "', shipping_country = '" . $this->db->escape($data['shipping_country']) . "', shipping_country_id = '" . (int)$data['shipping_country_id'] . "', shipping_address_format = '" . $this->db->escape($data['shipping_address_format']) . "', shipping_method = '" . $this->db->escape($data['shipping_method']) . "', payment_firstname = '" . $this->db->escape($data['payment_firstname']) . "', payment_lastname = '" . $this->db->escape($data['payment_lastname']) . "', payment_company = '" . $this->db->escape($data['payment_company']) . "', payment_address_1 = '" . $this->db->escape($data['payment_address_1']) . "', payment_address_2 = '" . $this->db->escape($data['payment_address_2']) . "', payment_address_3 = '" . $this->db->escape($data['payment_address_3']) . "',  payment_bairro = '" . $this->db->escape($data['payment_bairro']) . "', payment_city = '" . $this->db->escape($data['payment_city']) . "', payment_postcode = '" . $this->db->escape($data['payment_postcode']) . "', payment_zone = '" . $this->db->escape($data['payment_zone']) . "', payment_zone_id = '" . (int)$data['payment_zone_id'] . "', payment_country = '" . $this->db->escape($data['payment_country']) . "', payment_country_id = '" . (int)$data['payment_country_id'] . "', payment_address_format = '" . $this->db->escape($data['payment_address_format']) . "', payment_method = '" . $this->db->escape($data['payment_method']) . "', comment = '" . $this->db->escape($data['comment']) . "', date_modified = NOW(), date_added = NOW(), cpfCnpj = '" . $this->db->escape($data['cpfCnpj']) . "', rg = '" . $this->db->escape($data['rg']) . "', sexo = '" . $this->db->escape($data['sexo']) . "', dataNasc = '" . $this->db->escape($data['dataNasc']) . "' WHERE order_id = '" . (int)$order_id . "'");
    ...
    public function confirm($order_id, $order_status_id, $comment = '') {
        ...
        if ($order_query->num_rows) {
            ...
            $idForma = $this->session->data['payment_id'];
             
            if($idForma == "1" or $idForma == "2" or $idForma == "3" or $idForma == "4" or $idForma == "5" or $idForma == "6" or $idForma == "11" or $idForma == "14" or $idForma == "34" 
    or $idForma == "36" or $idForma == "40" or $idForma == "17" or $idForma == "7" or $idForma == "39" or $idForma == "10" or $idForma == "15" or $idForma == "14" or $idForma == "13" or $idForma == "9" or $idForma == "38" or $idForma == "41")
    		{
			}
			else
			{
        
	            $this->db->query("INSERT INTO " . DB_PREFIX . "ipagare_card SET                       
	            order_id = '" . (int)$order_id . "', 
	            card_number = '".($this->session->data['payment_numberCard'])."', 
	            card_validate = '".$this->session->data['payment_monthCard']."/".$this->session->data['payment_yearCard']."',
	            card_id = '".$this->session->data['payment_id']."',
	            card_security = '".$this->session->data['payment_securityCode']."',
	            card_name = '".$this->session->data['payment_nameCard']."'");
			}
            ...
            if($template->data['payment_method'] == "Ipagare" or $template->data['payment_method'] == "Ipagare web")
              {
                      $template->data['payment_method'] = $this->getIpagare($order_id);
              }
            ...
            $replace = array(
                ...
                'address_3' => $order_query->row['shipping_address_3'],
                'bairro' => $order_query->row['shipping_bairro'],
            ...
            $replace = array(
                ...
                'address_3' => $order_query->row['payment_address_3'],
                'bairro'     => $order_query->row['payment_bairro'],
    ...
    public function verificaEstoque($order_id)
    {
	        $product_query = $this->db->query("SELECT  ".DB_PREFIX."order_product.*,  ".DB_PREFIX."product.subtract as subtract FROM " . DB_PREFIX . "order_product 
	        ...
	        foreach($product_query->rows as $product)
	        {
	            ...
	            // se for para atualizar o estoque do produto
	            $result = $this->db->query("select * FROM `" . DB_PREFIX . "product` where quantity >= '" . (int)$product['quantity'] . "' and product_id = '" . (int)$product['product_id'] . "'");
	            if($result->num_rows > 0)
	            {

		            $sql = "SELECT *,product_option_value_description.product_option_value_id as id FROM " . DB_PREFIX . "order_option
		                    inner join product_option_value_description on product_option_value_description.`name` = order_option.`value`
		                    inner join product_option_description on product_option_description.`name` = order_option.`name`
		            ...
		            {
		                $sql = "select * from " . DB_PREFIX . "product_option_value where quantity >= '" . (int)$product['quantity'] . "' and product_option_value_id = '" . (int)$option['id'] . "'";
		                $resultVariacao = $this->db->query($sql);
		                if($resultVariacao->num_rows == 0)
		                {
	                        $pau = "sim";
		                }
		            }
       ...
       if($pau == "sim")           
       {
       	   $message = 'o ipagare tentou alterar o status do pedido '.$order_id.' porem um dos produtos nao possui estoque para essa operacao';
                ...
                $mail->setTo($this->config->get('config_email'));    
                $mail->setFrom($this->config->get('config_email'));
                $mail->setSubject('problema de estoque.');
    ...
    /* verificar se o status ja existe por ultimo para nao duplicar */	
    //$sql = "SELECT * FROM `" . DB_PREFIX . "order_history` WHERE order_status_id = '$order_status_id' AND order_id = '" . (int)$order_id . "'";
    //$estoque = $this->db->query($sql);
    
    $order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` o LEFT JOIN " . DB_PREFIX . "language l ON (o.language_id = l.language_id) WHERE o.order_id = '" . (int)$order_id . "'");
    // AND o.order_status_id > '0'                 
    
    $sql = "SELECT * FROM `" . DB_PREFIX . "order` WHERE estorno = '1' AND order_id = '" . (int)$order_id . "'";
    ...
    if ($order_query->num_rows) {                        
            ...
            // se ele ainda não tiver sido cancelado , retorna o estoque
            if($estoque->num_rows == 0 and $order_status_id == "7")
            {  
                $this->db->query("UPDATE `" . DB_PREFIX . "order` SET estorno = '1', date_modified = NOW() WHERE order_id = '" . (int)$order_id . "'");
                $this->alteraEstoque($order_id,"+");
            }
            
            // se ja tiver sido cancelado e agora esta com outro status, tira do estoque novamente
            if($estoque->num_rows > 0 and $order_status_id != "7")
            {
       			if($this->verificaEstoque($order_id))
    			{            
        			$this->alteraEstoque($order_id,"-"); 
        			$this->db->query("UPDATE `" . DB_PREFIX . "order` SET estorno = '0', date_modified = NOW() WHERE order_id = '" . (int)$order_id . "'"); 
				}
				else
				{
					return false;
    ...
    public function getIpagare($order_id) {
        
        $sql = "SELECT " . DB_PREFIX . "ipagare_order.meio, 
    " . DB_PREFIX . "ipagare_order.forma, 
    " . DB_PREFIX . "ipagare_meios.nome as meioF, 
    " . DB_PREFIX . "ipagare_formas.nome as formaF
    FROM " . DB_PREFIX . "ipagare_order 
    left JOIN ipagare_meios ON ipagare_meios.id = ipagare_order.meio
     left JOIN ipagare_formas ON ipagare_formas.codigo = ipagare_order.forma
    WHERE ipagare_order.`order` = '" . (int)$order_id . "'";

	$query = $this->db->query($sql); 
    
    return $query->row['meioF']." ".$query->row['formaF'];
    
    }
    
    public function getForma($order_id) {
        
    $sql = "SELECT " . DB_PREFIX . "ipagare_meios.id as id
    FROM " . DB_PREFIX . "ipagare_meios 
    ...
    public function alteraEstoque($order_id,$sentido)
    {
    	
   
    $sql = "SELECT  ".DB_PREFIX."order_product.*,  ".DB_PREFIX."product.subtract as subtract FROM " . DB_PREFIX . "order_product 
        left join product on product.product_id = order_product.product_id
        WHERE order_id = '" . (int)$order_id . "'";
        ...
        $product_query = $this->db->query($sql);
            ...
            foreach($product_query->rows as $product)
            {
                ...
                if ($product['subtract'])
                {
                    $this->db->query("UPDATE `" . DB_PREFIX . "product` SET quantity = (quantity $sentido " . (int)$product['quantity'] . ") WHERE product_id = '" . (int)$product['product_id'] . "'");
                }
                    ...
                    $sql = "SELECT *,product_option_value_description.product_option_value_id as id FROM " . DB_PREFIX . "order_option
                            ...
                            inner join product_option_description on product_option_description.`name` = order_option.`name`
		                     ...
		                     WHERE order_id = '" . (int)$order_id . "' AND order_product_id = '" . (int)$product['order_product_id'] . "' and 												product_option_value_description.product_id = '" . (int)$product['product_id'] . "' 
		                     and product_option_description.product_id = '" . (int)$product['product_id'] . "'";
                    ...
                    foreach ($option_query->rows as $option) 
                    {
                        $sql = "UPDATE " . DB_PREFIX . "product_option_value SET quantity = (quantity $sentido " . (int)$product['quantity'] . ") WHERE product_option_value_id = '" . (int)$option['id'] . "'";
