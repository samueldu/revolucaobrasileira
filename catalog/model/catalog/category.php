...
class ModelCatalogCategory extends Model {
	...
	public function getBanners($category_id,$position) {
		$query = $this->db->query("
		SELECT * 
		FROM " . DB_PREFIX . "banner as b
		INNER JOIN " . DB_PREFIX . "bannerCategoria as ba
		ON (b.id = ba.bannerId and ba.categoriaId = '$category_id') 
		where b.status = '1' and b.posicao='$position' and '".date('Y-m-d H:i:s')."' BETWEEN b.dataInicio AND b.dataFim");
