...
class ControllerCatalogManufacturer extends Controller { 
	private $error = array();
  	...
  	public function insert() {
		...
		$this->request->post['show_home'] = 0;
		else
		$this->request->post['show_home'] = 1;
  	...
  	private function getForm() {
		...
		$this->data['entry_show_home'] = $this->language->get('entry_show_home');
        ...
        $this->data['tab_hotsite'] = $this->language->get('tab_hotsite');
        ...
        */
		...
		if (isset($this->request->post['sort_order'])) {
  		...
  		if (isset($this->request->post['show_home'])) {
      		$this->data['show_home'] = $this->request->post['show_home'];
    	} elseif (isset($manufacturer_info)) {
			$this->data['show_home'] = $manufacturer_info['show_home'];
		} else {
  		...
  		if (isset($this->request->post['status'])) {
			...
			$this->data['status'] = $manufacturer_info['status_hotsite'];
		} else {
      		$this->data['status'] = '0';
    	}
  		...
  		if (isset($this->request->post['template'])) {
			...
			$this->data['template'] = $manufacturer_info['template'];
		} else {
      		$this->data['template'] = '';
    	}
