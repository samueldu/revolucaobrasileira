<?php
class ControllerModulehotsite extends Controller {
	private $error = array(); 
	
	public function index() {   
		$this->load->language('module/hotsite');

		$this->document->title = $this->language->get('heading_title');
		
		$this->load->model('setting/setting');
		$this->load->model('module/hotsite');
		...
		$this->data['productsCategories'] = $this->model_module_hotsite->getProductsCategorys();
		...
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/hotsite&token=' . $this->session->data['token'];
		...
		$this->template = 'module/hotsite.tpl';
		$this->children = array(
			'common/header',	
			'common/footer'	
		);
