...
class ControllerModulefbconnect extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->redirect('extension/module', 'token=' . $this->session->data['token'], 'SSL');
		}
		...
		if (isset($this->error['code'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => 'common/home?token=' . $this->session->data['token'],
      		'separator' => false
   		);

   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('text_module'),
			'href'      => 'extension/module/?token=' . $this->session->data['token'],
      		'separator' => ' :: '
   		);
		
   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => 'module/fbconnect/?token=' . $this->session->data['token'],
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = 'index.php?route=module/fbconnect&token=' . $this->session->data['token'];
		
		$this->data['cancel'] = 'index.php?route=extension/fbconnect&token=' . $this->session->data['token'];
