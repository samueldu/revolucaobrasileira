...
class ControllerModuleGoogleanalytics extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_ua'] = $this->language->get('entry_ua');
		...
		$this->data['button_cancel'] = $this->language->get('button_cancel');
 		...
 		if (isset($this->error['code'])) {
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'index.php?route=module/google_analytics&token=' . $this->session->data['token'],
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/google_analytics&token=' . $this->session->data['token'];
		...
		if (isset($this->request->post['google_analytics_ua_code'])) {
			$this->data['google_analytics_ua_code'] = $this->request->post['google_analytics_ua_code'];
		} else {
