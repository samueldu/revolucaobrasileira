...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_integration_stock'] = $this->language->get('text_integration_stock');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['inventory_update'] = HTTPS_SERVER . 'index.php?route=tool/inventory_update&token=' . $this->session->data['token'];
			$this->data['integration_stock'] = HTTPS_SERVER . 'index.php?route=integration/integration_stock&token=' . $this->session->data['token']; 			
			...
			$this->data['blog'] = HTTPS_SERVER . 'index.php?route=extension/blog&token=' . $this->session->data['token'];  
			...
			$this->data['banner'] = HTTPS_SERVER . 'index.php?route=catalog/banner&token=' . $this->session->data['token'];
				//newsletter template
			$this->data['template'] = HTTPS_SERVER . 'index.php?route=sale/newsletter_template&token=' . $this->session->data['token'];						
			//newsletter template
			//Newsletter Subscribers
			$this->data['newssubscribe'] = HTTPS_SERVER . 'index.php?route=sale/newssubscribers&token=' . $this->session->data['token'];						
			//Newsletter Subscribers
