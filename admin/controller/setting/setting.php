...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_order_stock'] = $this->language->get('entry_order_stock');
        ...
        $this->data['entry_risk'] = $this->language->get('entry_risk');   

        $this->data['entry_face_comm'] = $this->language->get('entry_face_comm');    
        $this->data['entry_face_comm_app'] = $this->language->get('entry_face_comm_app');    
		...
		if (isset($this->request->post['config_url'])) {
			...
			$this->data['config_url'] = $this->config->get('config_url_admin');
		}
		...
		if (isset($this->request->post['config_order_stock'])) {
			$this->data['config_order_stock'] = $this->request->post['config_order_stock'];
		} else {
			$this->data['config_order_stock'] = $this->config->get('config_order_stock');			
		}
		...
		if (isset($this->request->post['config_clear_sale_entity'])) {
			$this->data['config_clear_sale_entity'] = $this->request->post['config_clear_sale_entity'];
		} else {
			$this->data['config_clear_sale_entity'] = $this->config->get('config_clear_sale_entity');
		}
		
		if (isset($this->request->post['config_risk_partner'])) {
			$this->data['config_risk_partner'] = $this->request->post['config_risk_partner'];
		} else {
			$this->data['config_risk_partner'] = $this->config->get('config_risk_partner');
		}
    		
		$this->data['riskPartners']  = array("T-Clear-Sale","Tg-Clear-Sale","M-Clear-Sale");
		
		if (isset($this->request->post['config_risk_status'])) {
			$this->data['config_risk_status'] = $this->request->post['config_risk_status'];
		} else {
			$this->data['config_risk_status'] = $this->config->get('config_risk_status');
		}
		
		/* facebook */		
		if (isset($this->request->post['config_face_comm'])) {
			$this->data['config_face_comm'] = $this->request->post['config_face_comm'];
		} else {
			$this->data['config_face_comm'] = $this->config->get('config_face_comm');
		}
		
		if (isset($this->request->post['config_face_comm_app'])) {
			$this->data['config_face_comm_app'] = $this->request->post['config_face_comm_app'];
		} else {
