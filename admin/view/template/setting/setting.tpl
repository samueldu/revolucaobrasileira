    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="tab_option">
        <table class="form">
          ...
          <tr>
            <td><?php echo $entry_order_stock; ?></td>
            <td><?php if ($config_order_stock) { ?>
              <input type="radio" name="config_order_stock" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="config_order_stock" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="config_order_stock" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="config_order_stock" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
          <tr>
      ...
      <div id="tab_server">
        ...
        <table class="form">
          <tr>
            <td><?php echo $entry_face_comm; ?></td>
            <td><?php if ($config_face_comm) { ?>
              <input type="radio" name="config_face_comm" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="config_face_comm" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="config_face_comm" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="config_face_comm" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
          <tr>
            <td><?php echo $entry_face_comm_app; ?></td>
            <td>
             <input type="text" name="config_face_comm_app" value="<?=$config_face_comm_app?>" /></td>
          </tr>
        </table>
      </div>
       ...
       <div id="tab_risk">
        <table class="form">
          <tr>
            <td><?php echo $entry_risk; ?></td>
            <td><?php if ($config_risk_status) { ?>
              <input type="radio" name="config_risk_status" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="config_risk_status" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="config_risk_status" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="config_risk_status" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
          <tr>
            ...
            <td>
            <select name="config_risk_partner">
            <?php foreach ($riskPartners as $risk) { ?>
            <?php if ($risk == $config_risk_partner) { ?>
            <option value="<?php echo $risk; ?>" selected="selected"><?php echo $risk; ?></option>
            <?php } else { ?>
            <option value="<?php echo $risk; ?>"><?php echo $risk; ?></option>
            <?php } ?>
            <?php } ?>
            </select>
            </td>
          ...
          <tr>
            ...
            <td><input type="text" name="config_clear_sale_entity" value="<?=$config_clear_sale_entity?>" /></td>
          </tr>
        </table>
      </div>            
