...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="htabs"><a tab="#tab_general"><?php echo $tab_general; ?></a><a tab="#tab_data"><?php echo $tab_data; ?></a><a tab="#tab_hotsite"><?php echo $tab_hotsite; ?></a></div>
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <div id="tab_general">
	      ...
	      <table class="form">
	        <tr>
	          <td><span class="required">*</span> <?php echo $entry_name; ?></td>
  	          <td><input name="manufacturer_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($manufacturer_description[$language['language_id']]) ? $manufacturer_description[$language['language_id']]['name'] : ''; ?>" />
        ...
        <td><?php echo $entry_meta_keywords; ?></td>
              <td><textarea name="manufacturer_description[<?php echo $language['language_id']; ?>][meta_keywords]" cols="40" rows="5"><?php echo isset($manufacturer_description[$language['language_id']]) ? $manufacturer_description[$language['language_id']]['meta_keywords'] : ''; ?></textarea></td>
            </tr>
            <tr>
      ...
      <div id="tab_data">
        ...
        $checked = ''; ?>
        <tr>
          <td><?php echo $entry_show_home; ?></td>
          <td><input type="checkbox" name="show_home" value="<?php echo $show_home; ?>" <?=$checked?> /></td>
        </tr>
         </table>
      </div>
      <div id="tab_hotsite">
      	<table class="form">
	        ...
	        <tr>
	            ...
	            <td><input type="text" name="template" value="<?php echo $template; ?>"></td>
      		</tr>
      	</table>
      </div>
    </form>
