      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'b.nome') { ?>
              <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
              <?php } else { ?>
              <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
              <?php } ?></td>
            <td class="left"><?php if ($sort == 'b.posicao') { ?>
        ...
        <tbody>
          <tr class="filter">
            ...
            <td><select name="filter_model"><option value="*"></option><option value="topo">Topo</option><option value="baixo">Baixo</option></select></td>
          ...
          <tr>
            ...
            <td class="left"><?php echo $product['nome']; ?></td>
...
function filter() {
	url = 'index.php?route=catalog/banner&token=<?php echo $token; ?>';
	...
	var filter_model = $('select[name=\'filter_model\']').attr('value');
