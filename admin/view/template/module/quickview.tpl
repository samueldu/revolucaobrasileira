    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><select name="quickview_position">
              <?php foreach ($positions as $position) { ?>
              <?php if ($quickview_position == $position['position']) { ?>
        ...
        <tr>
          ...
          <td><select name="quickview_status">
              <?php if ($socialnetwork_status) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="quickview_sort_order" value="<?php echo $quickview_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
