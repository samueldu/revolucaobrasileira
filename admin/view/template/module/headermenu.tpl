...
<?php } ?>
        ...
        <tr>
          ...
          <td><select name="headermenu_status">
              <?php if ($headermenu_status) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="headermenu_sort_order" value="<?php echo $headermenu_sort_order; ?>" size="1" /></td>
        </tr>
      </table>
    </form>
  </div>
