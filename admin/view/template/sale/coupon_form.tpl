      ...
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="code" value="<?php echo $code; ?>" />
            ...
            <?php } ?>
			<?//echo "Bot�o 'Gerar Codigo'";?><!--td class="buttons"><a onclick="$('#form').submit();" class="button"><span><?php echo $button_gerar_codigo; ?></span></a></td-->
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><textarea rows="2" name="emails" cols="20" <?if($insertCupom == "0") print "disabled=disabled";?>>samueldu@gmail.com
          tiagopuel@gmail.com	</textarea>
		 </td>
        </tr>
        <tr>
