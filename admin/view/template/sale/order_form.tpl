...
<div class="box">
  ...
  <div class="content">
    <div style="display: inline-block; width: 100%;">
      ...
      <a tab="#tab_order"><?php echo $tab_order; ?></a>
      
      <?php
      
      if(count($risk_history) > 0)
      {
      ?>
	  <a tab="#tab_risk"><?php echo $tab_risk; ?></a>		  
	  <?
      }
      ?>
      
      
      <a tab="#tab_product"><?php echo $tab_product; ?></a>
      
      <a tab="#tab_shipping"><?php echo $tab_shipping; ?></a><!--a tab="#tab_payment"><?php echo $tab_payment; ?></a--><a tab="#tab_history"><?php echo $tab_history; ?></a></div>
      ...
      <div id="tab_order" class="vtabs_page">
        <table class="form">
          ...
          <tr>
            <td><?php echo $entry_rastreamento; ?></td>
            <td id="rastrea"><input type="text" name="rastreamento" id="rastreamento" value="<?php if ($rastreamento) {  echo $rastreamento; }?>">
               <a class="button"><span id="salvarRastreamento"><?php echo $button_save; ?></span></a>
              </td>
          </tr>
          <!--tr>
      ...
      {
      ?>
	  <div id="tab_risk" class="vtabs_page">
        <table class="form">
          <tr>
            <td><?php echo $entry_risk_partner; ?></td>
            <td><?php echo $risk_partner; ?></td>
          </tr>
          ...
          foreach($risk_history as $key=>$value)
          {
			  ?>
		  <tr>
            <td>Score <b><?php echo $risk_history[$key]['score']; ?>%</b></td>
            <td><?php echo $risk_history[$key]['descricao']; ?></td>
          </tr>
          <?
          }
          ?>
      ...
      <div id="tab_shipping" class="vtabs_page">
        ...
        <table class="form">
          ...
          <tr>
            <td><?php echo $entry_address_3; ?></td>
            <td><input type="text" name="shipping_address_3" value="<?php echo $shipping_address_3; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_bairro; ?></td>
            <td><input type="text" name="shipping_bairro" value="<?php echo $shipping_bairro; ?>" /></td>
          </tr>
          <tr>
      ...
      <div id="tab_history" class="vtabs_page">
        ...
        <table class="form">
          <tr>
            ...
            <td><select name="order_status_id" onChange="checkInfo(this.value)">
...
$('#salvarRastreamento').click(function() {

	$.post('index.php?route=sale/order/salvarRastreamento&token=<?php echo $token; ?>&order_id=<?php echo $order_id;?>&email=<?=$email?>', { 
		rastreamento : document.getElementById('rastreamento').value, 
