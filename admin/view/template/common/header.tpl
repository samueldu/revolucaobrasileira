  ...
  <ul class="nav left" style="display: none;">
	...
	<li id="sale"><a class="top"><?php echo $text_sale; ?></a>
	  <ul>
		...
		<li><a href="<?php echo $order_new; ?>"><?php echo $text_order_new; ?></a></li>
	...
	<li id="system"><a class="top"><?php echo $text_system; ?></a>
	  <ul>
		...
		<li><a href="<?php echo $inventory_update; ?>"><?php echo $text_inventory_update; ?></a></li>
		<li><a href="<?php echo $integration_stock; ?>"><?php echo $text_integration_stock; ?></a></li>
	  </ul>
	</li>
	<li id="reports"><a class="top"><?php echo $text_reports; ?></a>
	  <ul>
		...
		<li><a href="<?php echo $report_stock; ?>"><?php echo $text_report_stock; ?></a></li>
	  </ul>
	</li>
