...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
        ...
        foreach ($query->rows as $manufacturer) {
            $this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer_description SET manufacturer_id = '" . (int)$manufacturer['manufacturer_id'] . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($manufacturer['name']) . "', meta_description= '" . $this->db->escape($manufacturer['meta_description']) . "', description = '" . $this->db->escape($manufacturer['description']) . "'");
        }
