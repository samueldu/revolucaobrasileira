...
class AutoEmbed {
  ...
  public function getImageURL() {
    if (!isset($this->_stub['image-src']) and $this->_stub['title'] != "Vimeo")
        return false;

   if($this->_stub['title'] == "Vimeo")
    {
        $url = "http://vimeo.com/api/v2/video/".$this->_media_id[0].".php";

        if(@file_get_contents("http://vimeo.com/api/v2/video/".$this->_media_id[1].".php"))
        @$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/".$this->_media_id[1].".php"));
