...
final class Image {
    ...
    public function save($file, $quality = 100) {
        ...
        if ($extension == 'jpeg' || $extension == 'jpg' and !is_null($this->image)) {
...
//      $ypos = (int)(($height - $new_height) / 2); //original code commented out
    ...
    public function cropsize($width = 0, $height = 0) {
        ...
        if ((!$this->info['width'] || !$this->info['height']) or ($this->info['width'] == "0" or $this->info['height'] == "0" or $height == "0")) {
            return;
        }
	...
	public function resize($width = 0, $height = 0) {
		...
		imagecopyresampled($this->image, $image_old, $xpos, $ypos, 0, 0, $new_width, $new_height, $this->info['width'], $this->info['height']);
		//print $this->image."<BR>";
		if(!imagedestroy($image_old))
		{
			//print "impossivel deletar ".$image_old;
		}
